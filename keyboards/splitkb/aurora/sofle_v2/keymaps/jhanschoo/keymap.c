...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    ...
    [_DEFAULT] = LAYOUT(
        ...
        KC_TAB, KC_Z,   KC_X,   KC_C,   KC_V,   KC_B,   KC_CAPS,
            LC_SPC, KC_N,   KC_M,   KC_COMM,KC_DOT, KC_SLSH,KC_QUOT,
        KC_LALT,KC_RALT,MO_L,   KC_SPC, KC_LCTL,
            KC_ESC, KC_LSFT,MO_R,   KC_APP,   KC_LWIN
    ),
    // Colemak-DH layer
    [_COLEMAKDH] = LAYOUT(
    ...
    [_GAME] = LAYOUT(
        ...
        KC_LSFT,KC_A,   KC_S,   KC_D,   KC_F,   KC_G,
            KC_H,   KC_J,   KC_K,   KC_L,   KC_SCLN,KC_ENT,
        KC_LCTL,KC_Z,   KC_X,   KC_C,   KC_V,   KC_B,   KC_CAPS,
            LC_SPC, KC_N,   KC_M,   KC_COMM,KC_DOT, KC_SLSH,KC_QUOT,
        KC_LALT,KC_LWIN,MO_L,   KC_SPC, KC_BSPC,
    ...
    [_LOWER] = LAYOUT(
        ...
        _______,_______,MO_A,   _______,_______,
            KC_LEFT,KC_RGHT,MO_A,   KC_UP,  KC_DOWN
    ),
    // Raise layer
    [_RAISE] = LAYOUT(
        _______,KC_F1,  KC_F2,  KC_F3,  KC_F4,  KC_F5,
            KC_F6,  KC_F7,  KC_F8,  KC_F9,  KC_F10, KC_F11,
        _______,KC_HOME,KC_PGUP,KC_PGDN,KC_END, KC_PSCR,
            KC_PSCR,KC_HOME,KC_PGUP,KC_PGDN,KC_END, KC_F12,
        KC_DEL, KC_LEFT,KC_UP,  KC_DOWN,KC_RGHT,KC_SCRL,
            KC_SCRL,KC_LEFT,KC_UP,  KC_DOWN,KC_RGHT,KC_DEL,
        KC_INS, KC_LEFT,KC_UP,  KC_DOWN,KC_RGHT,KC_PAUS,_______,
            _______,KC_PAUS,KC_LEFT,KC_UP,  KC_DOWN,KC_RGHT,KC_INS,
        _______,_______,MO_A,   _______,_______,
            KC_LEFT,KC_UP,  _______,KC_DOWN,KC_RGHT
    ),
    // Adjust layer
    [_ADJUST] = LAYOUT(
